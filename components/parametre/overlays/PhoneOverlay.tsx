// components/parametre/overlays/PhoneOverlay.tsx
'use client'
...
export default function PhoneOverlay({ phone, onPhoneChange, onSave, onCancel }: PhoneOverlayProps) {
  return (
    <div className="fixed inset-0 bg-[#0a0a1a]/85 backdrop-blur-xl z-[1000] flex items-center justify-center p-4" onClick={onCancel}>
      ...
      >
        ...
        <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2.5">Modifier le numero</h3>
        <input 
          type="tel" 
          value={phone} 
