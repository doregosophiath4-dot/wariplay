// components/parametre/overlays/CodeOverlay.tsx
'use client'
...
export default function CodeOverlay({ code, onCodeChange, onConfirm, onCancel }: CodeOverlayProps) {
  return (
    <div className="fixed inset-0 bg-[#0a0a1a]/85 backdrop-blur-xl z-[1000] flex items-center justify-center p-4" onClick={onCancel}>
      ...
      >
        ...
        <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2.5">Code de verification</h3>
        <input 
          type="text" 
          value={code} 
          onChange={(e) => onCodeChange(e.target.value)} 
          placeholder="Entrez le code recu"
          className="w-full px-4 py-3.5 rounded-xl bg-white/[0.04] border border-white/10 text-white outline-none text-center text-lg tracking-widest mb-5 focus:border-emerald-400/40" 
        />
